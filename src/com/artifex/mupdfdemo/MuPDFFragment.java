...
public class MuPDFFragment extends Fragment {
					...
					if (cursor.moveToFirst()) {
						...
						if (str == null) {
							...
							if (reason != null)
							{
								...
								getActivity().setTitle(String.format(res.getString(R.string.cannot_open_document_Reason), reason));
	...
	{
		mReflow = reflow;
		mDocView.setAdapter(mReflow ? new MuPDFReflowAdapter(getActivity(), core) : new MuPDFPageAdapter(getActivity(), core));
	...
	private void showInfo(String message) {
		...
		if (currentApiVersion >= android.os.Build.VERSION_CODES.HONEYCOMB) {
			SafeAnimatorInflater safe = new SafeAnimatorInflater((Activity)getActivity(), R.animator.info, (View)mInfoView);
		} else {
