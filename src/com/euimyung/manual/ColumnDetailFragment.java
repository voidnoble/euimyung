...
public class ColumnDetailFragment extends Fragment {
     ...
     */
    private ColumnItems.ColumnItem mItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (arguments != null) {
	        if (arguments.containsKey(ARG_ITEM_ID)) {
	            ...
	            mItem = ColumnItems.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));
	        }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.column_detail, container, false);
//        mTextView = (TextView) rootView.findViewById(R.id.item_detail);
        ...
        if (mItem != null) {
        	try {
        		...
        		String fileName = "column"+ mItem.id +".html";
...
//		inflater.inflate(R.menu.column_detail, menu);
	}
